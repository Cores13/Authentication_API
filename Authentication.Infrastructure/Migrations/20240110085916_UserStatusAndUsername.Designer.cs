...
namespace Authentication.Infrastructure.Migrations
{
    ...
    [Migration("20240110085916_UserStatusAndUsername")]
    partial class UserStatusAndUsername
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 1, 10, 8, 59, 15, 409, DateTimeKind.Utc).AddTicks(6504),
                            Email = "superadmin@Authentication.com",
                            EmailVerifiedAt = new DateTime(2024, 1, 10, 8, 59, 15, 409, DateTimeKind.Utc).AddTicks(8404),
                            Name = "Super User",
                            ...
                            RefreshTokenExpiryTime = new DateTime(2024, 1, 10, 8, 59, 15, 409, DateTimeKind.Utc).AddTicks(8905),
                            ResetPasswordExpiry = new DateTime(2024, 1, 10, 8, 59, 15, 409, DateTimeKind.Utc).AddTicks(9529),
                            Role = 1,
                            Status = 1,
                            UpdatedOn = new DateTime(2024, 1, 10, 8, 59, 15, 409, DateTimeKind.Utc).AddTicks(6878),
                            Username = "Super User"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2024, 1, 10, 8, 59, 15, 410, DateTimeKind.Utc).AddTicks(931),
                            Email = "admin@Authentication.com",
                            EmailVerifiedAt = new DateTime(2024, 1, 10, 8, 59, 15, 410, DateTimeKind.Utc).AddTicks(935),
                            Name = "Admin",
                            PasswordHash = new byte[] { 35, 90, 244, 18, 43, 21, 195, 38, 253, 159, 107, 4, 55, 18, 200, 156, 84, 209, 241, 56, 27, 72, 90, 53, 220, 177, 39, 238, 117, 222, 23, 141, 154, 189, 55, 192, 113, 129, 205, 207, 226, 181, 138, 80, 84, 166, 226, 153, 64, 24, 39, 131, 91, 56, 154, 150, 210, 129, 163, 197, 230, 210, 1, 184 },
                            PasswordSalt = new byte[] { 141, 249, 58, 0, 174, 228, 48, 60, 70, 120, 31, 142, 153, 188, 235, 210, 202, 154, 79, 198, 74, 194, 78, 154, 133, 112, 30, 189, 171, 202, 164, 9, 106, 78, 229, 131, 106, 18, 44, 114, 165, 89, 98, 17, 156, 31, 248, 142, 103, 98, 52, 176, 27, 154, 19, 178, 8, 31, 81, 183, 114, 237, 44, 80, 213, 69, 239, 33, 27, 95, 113, 116, 150, 169, 203, 208, 49, 84, 57, 29, 132, 148, 75, 131, 223, 59, 207, 147, 37, 91, 50, 190, 55, 204, 95, 113, 39, 201, 179, 191, 245, 184, 61, 146, 8, 47, 145, 224, 10, 240, 216, 97, 159, 135, 199, 201, 113, 50, 57, 45, 232, 72, 16, 138, 86, 166, 101, 64 },
                            RefreshTokenExpiryTime = new DateTime(2024, 1, 10, 8, 59, 15, 410, DateTimeKind.Utc).AddTicks(936),
                            ResetPasswordExpiry = new DateTime(2024, 1, 10, 8, 59, 15, 410, DateTimeKind.Utc).AddTicks(937),
                            Role = 2,
                            Status = 1,
                            UpdatedOn = new DateTime(2024, 1, 10, 8, 59, 15, 410, DateTimeKind.Utc).AddTicks(932),
                            Username = "Admin"
                        });
                });
